...
exports.passDependencies = function (mageInstance, mageLogger) {
	mage = mageInstance;
	logger = mageLogger;
};
		...
		if (value === '') {
			...
			try {
				...
				if (value && value.__type) {
					value = mage.core.datatypes.createValue(value.__type, value);
				}
			} catch (e) {
				mage.core.logger.error('Could not unserialize object from string:', value);
				value = {};
			}
		}
		break;
