...
exports.passDependencies = function (mageLogger, dTypes) {
	logger = mageLogger;
	dataTypes = dTypes;
};
		...
		if (value === '') {
			...
			try {
				...
				if (value && value.__type) {
					value = dataTypes.createValue(value.__type, value);
				}
			} catch (e) {
				logger.error('Could not unserialize object from string:', value);
				value = {};
			}
		}
		break;
