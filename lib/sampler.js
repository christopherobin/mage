...
function setupEventCounters() {
	...
	commandCenter.on('completed', function (cmd, duration) {
		panopticon.sample('userCommand:' + cmd.name, duration);
	});
}
