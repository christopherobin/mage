...
exports.setup = function () {
	...
	// The methods of a panopticon for dealing with data.
	var methods = ['sample', 'timedSample', 'set', 'inc'];

	// Exported functions are just methods of panoptica. We want to send data to all panoptica.
