...
var getSqlReadTimeOut = require('./state').getSqlReadTimeOut;
var getSqlWriteTimeOut = require('./state').getSqlWriteTimeOut;
var getSqlLockWaitTimeOut = require('./state').getSqlLockWaitTimeOut;
var getSqlMiscError = require('./state').getSqlMiscError;
...
var getOpenPostConnections = require('./commandCenter').getOpenPostConnections;
var getTotalPostConnections = require('./commandCenter').getTotalPostConnections;
...
function mithrilSamplers() {
	...
	exports.sample('open.post.connections', getOpenPostConnections);
	exports.inc('sqlError.readTimeOut', getSqlReadTimeOut);
	exports.inc('sqlError.writeTimeOut', getSqlWriteTimeOut);
	exports.inc('sqlError.lockWaitTimeOut', getSqlLockWaitTimeOut);
	exports.inc('sqlError.misc', getSqlMiscError);
	exports.set('total.post.connections', getTotalPostConnections);
