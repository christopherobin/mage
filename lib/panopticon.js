...
function WorkerData(startTime, interval) {
	...
	this.timer = setTimeout(function (that) {
		console.log('timed out ', (cluster.isMaster ? 'Master' : cluster.worker.id));
		that.timeUp();
...
WorkerData.prototype.timeUp = function () {
	...
	if (now >= this.endTime) {
		console.log((cluster.isMaster ? 'Master' : cluster.worker.id) + ' endTime: ' + this.endTime + ' now ' + now);
		// Emit the sample!
		...
		//console.log('ELSE ON ' + (cluster.isMaster ? 'Master' : cluster.worker.id));
		//console.log('now', now);
		//console.log('endTime', this.endTime);
		//console.log('diff', now - this.endTime);
	//}
};
