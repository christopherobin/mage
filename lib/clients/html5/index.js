...
var pathlistBuilder = mage.core.app.builders.get('pathlist');
var dirBuilder = mage.core.app.builders.get('dir');
...
function buildCore(buildTarget, language, contextName, cb) {
	...
	pathlistBuilder.build(buildTarget, language, contextName, paths, cb);
}
...
function buildLoader(buildTarget, language, contextName, cb) {
	...
	dirBuilder.build(buildTarget, language, contextName, path, cb);
}
...
mage.core.app.builders.add('html5client', exports);
