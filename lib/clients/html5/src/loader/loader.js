...
// It is now the loader component
//  - lib/loader/component.json
//  - lib/loader/index.js
...
(function (window) {
	...
	mod.loadPage = function (name) {
		...
		var url = $app('clientHostBaseUrl') + '/app/' + appName + '/' + name + '?language=' + language + '&screen=' + screen + '&density=' + density;
	...
	mod.displayPage = function (name) {
		...
		mod.emit(displayedPage + '.display', found);
	};
