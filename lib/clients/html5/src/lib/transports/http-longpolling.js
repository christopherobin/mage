...
//  - /lib/msgServer/transports/http-longpolling/client.js
...
(function (window) {
	...
	HttpLongPolling.prototype = new window.EventEmitter();


	mage.io.transports['http-longpolling'] = HttpLongPolling;
