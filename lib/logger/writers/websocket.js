// TODO: rename to WebsocketWriter
...
function WebsocketWriter(cfg, parser) {

	var id   = 0,
		that = this;

	this.parser				= parser;
	this.server				= new WSS({ port: cfg.port });   // TODO: what about the host?
...
WebsocketWriter.prototype.send = function (channel, id, data) {
    var that = this;
