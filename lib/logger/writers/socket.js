...
var socket = function (cfg, parser) {
...
util.inherits(socket, writer.writer);

socket.prototype.channelFunctionGenerator = function (channel) {
...
socket.prototype.send = function (channel, id, data) {
    var that = this;
...
socket.prototype.setupLogForwarder = function () {
	var that = this;
...
socket.prototype.setupLogCollector = function () {
	var that = this;
