var LogQueue = require('./queue').LogQueue;
...
var logCreator = new LogCreator(queue, channelMap);


exports.getCreator = function (newInstance) {
	if (newInstance) {
		return new LogCreator(queue, channelMap);
	}
