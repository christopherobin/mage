...
exports.configure = function () {
	var cfg = (mage.core.config.logging && mage.core.config.logging.server) || {};
	...
	if (cfgTypes.length === 0) {
		mage.core.config.setTopLevelDefault('logging', require('./config.yaml'));

		cfg = mage.core.config.logging.server;
