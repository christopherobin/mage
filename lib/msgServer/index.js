...
exports.setup = function () {
	...
	mithril.core.logger.verbose('Setting up msgServer');

	if (!pm.isMaster) {
		// set up the clientHost

		mithril.core.logger.verbose('Setting up msgServer clientHost');
	...
	mithril.core.logger.verbose('Setting up msgServer comm');
...
exports.startClientHost = function () {
	mithril.core.logger.verbose('Starting clientHost...');
