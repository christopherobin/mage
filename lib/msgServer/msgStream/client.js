var transports = {
	longpolling: require('./transports/http-polling/client.js').longpolling,
	shortpolling: require('./transports/http-polling/client.js').shortpolling,
	websocket: require('./transports/websocket/client.js')
};
