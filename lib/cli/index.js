...
exports.run = function () {
	...
	var packageName = mage.rootPackage.name;
	var argv = helpers.deepCopy(process.argv);

	argv = tabComplete.addCompletionCommands(packageMain, packagePath, packageName, argv);
