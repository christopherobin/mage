...
program
	...
	.action(function (app) {
		mage.setTask(require('../tasks/create-phantom'), { app: app });
	});
...
program
	...
	.action(function (trail) {
		mage.setTask(require('../tasks/show-config'), { trail: trail });
	});
...
program
	...
	.action(function (version) {
		mage.setTask(require('../tasks/archivist-migrate'), { version: version });
	});
...
program
	...
	.action(function () {
		mage.setTask(require('../tasks/daemonize'), { command: 'start' });
	});
...
program
	...
	.action(function () {
		mage.setTask(require('../tasks/daemonize'), { command: 'stop' });
	});
...
program
	...
	.action(function () {
		mage.setTask(require('../tasks/daemonize'), { command: 'restart' });
	});
...
program
	...
	.action(function () {
		mage.setTask(require('../tasks/daemonize'), { command: 'reload' });
	});
...
program
	...
	.action(function () {
		mage.setTask(require('../tasks/daemonize'), { command: 'status' });
	});
