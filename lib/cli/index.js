...
program
	.command('create-phantom <app> <output-file>')
	.description('create a PhantomJS client for the given app')
	.action(function (app, file) {
		mage.setTask(require('../tasks/create-phantom').bind(null, app, file));
	});
