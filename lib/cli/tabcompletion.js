...
function addTabCompletionToProject(projectRootFolder, bashCompletionFile) {
	if (!isTabCompletionScriptInFile(projectRootFolder, bashCompletionFile)) {
		var contents = 'source ' + projectRootFolder + '/' + DEFAULT_COMPLETION_FILENAME + '\n';
		fs.prependFileSync(bashCompletionFile, contents);
	}
}
