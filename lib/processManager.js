...
WorkerManager.prototype.createWorker = function (cb) {
	...
	worker = cluster.fork({ MASTER_PID: process.pid });
...
WorkerManager.prototype.killWorker = function (worker, graceful, cb) {
	...
	var shutdownGracePeriod = graceful ? mithril.core.config.get('server.shutdownGracePeriod', 15) : 2;
