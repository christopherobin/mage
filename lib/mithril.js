...
exports.core.app              = require('./app');
exports.core.datatypes        = require('./datatypes');
exports.core.serviceDiscovery = new (require('./serviceDiscovery')).ServiceDiscovery();
exports.core.clients          = require('./clients');
exports.core.msgServer        = require('./msgServer');
exports.core.cmd              = require('./commandCenter');


exports.core.app.builders.add('cfg', function (buildTarget, language, context, key, cb) {
...
exports.addCommandCenter = function (appName, requirements, commandList) {
	var commandCenter = new exports.core.cmd.CommandCenter(appName);

	if (requirements && commandList) {
		commandCenter.expose(requirements, commandList);
	}

	exports.core.commandCenters[appName] = commandCenter;
...
function setupLogger() {
	...
	if (oldCfg) {
		...
		if (oldCfg.logPath) {
			for (var channelName in oldCfg.log) {
				if (oldCfg.log[channelName] === 'file') {
					cfg.output = 'file';
		...
		if (oldCfg.log) {
			cfg.show = Object.keys(oldCfg.log);
		}
	} else {
