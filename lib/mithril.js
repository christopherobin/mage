...
function Mithril() {
	...
	this.isShuttingDown = false;  // TODO: rename to "runstate" or something and make it a string
	this._modulesList = [];
...
Mithril.prototype.setup = function (pathConfig, cb) {
	...
	try {
		...
		deprecatedMessages.logger(this.core.logger);
...
// Create Mithril and override the exported API.
...
deprecatedMessages.logger = function (logger) {
	var example = {
        logging: {
			html5: {
				console: {
