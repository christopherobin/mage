...
*/
	...
	toolApp.setIndexPage('/home/te/mithril/tools/pages/loader');
	...
	Viewport.prototype.build = function (buildTarget, language, contextName, key, cb) {
		...
		async.forEachSeries(
			...
			function (view, callback) {
				var path = '/home/te/mithril/tools/views/' + view.className;
	...
	toolApp.addPage('main', '/home/te/mithril/tools/pages/main', { assetMap: toolAssets });
