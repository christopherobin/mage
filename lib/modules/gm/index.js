...
exports.exposeTool = function (cb) {
	...
	// this will probably conflict later

	// TODO: only do all this for modules that are used, don't hard copy these. IE:
/*
	var commands = {};

	for (var modName in mithril.modules) {
		var mod = mithril.modules[modName];
...
*/
	...
	mithril.addCommandCenter(
		...
		{ hooks: ['mithril.session'] },
		{
			...
			msg:     ['sync'],
			npc:     ['sync'],
			player:  ['editPlayer', 'getPlayers', 'getPlayerData', 'sync'],
			shop:    ['createShop', 'editShop', 'deleteShop', 'getShops', 'createItem', 'editItem', 'deleteItem', 'createItemObject', 'createItemObjects', 'editItemObject', 'deleteItemObject', 'deleteItemObjects', 'sync'],
			sns:     ['sync'],
			obj:     ['sync'],
	...
	toolApp.setIndexPage('../../www/pages/loader');

	// toolApp.addBuilder('view', require('./viewport'));
	...
	Viewport.prototype.build = function (buildTarget, language, contextName, key, cb) {
		...
		async.forEachSeries(
			...
			function (view, callback) {
				var path = '../../www/views/' + view.className;
	...
	var toolAssets = mithril.assets.createAssetMap();

	// Registering images for jquery ui

	toolAssets.regImg   = toolAssets.regFile.bind(toolAssets, 'img');

	toolAssets.regImg('tool/ui-bg_diagonals-thick_8_333333_40x40', '/$0.png');
	toolAssets.regImg('tool/ui-bg_flat_65_ffffff_40x100', '/$0.png');
	toolAssets.regImg('tool/ui-bg_glass_40_111111_1x400', '/$0.png');
	toolAssets.regImg('tool/ui-bg_glass_55_1c1c1c_1x400', '/$0.png');
	toolAssets.regImg('tool/ui-bg_highlight-hard_40_aaaaaa_1x100', '/$0.png');
	toolAssets.regImg('tool/ui-bg_highlight-hard_100_f9f9f9_1x100', '/$0.png');
	toolAssets.regImg('tool/ui-bg_highlight-soft_50_aaaaaa_1x100', '/$0.png');
	toolAssets.regImg('tool/ui-bg_inset-hard_45_cd0a0a_1x100', '/$0.png');
	toolAssets.regImg('tool/ui-bg_inset-hard_55_ffeb80_1x100', '/$0.png');
	toolAssets.regImg('tool/ui-icons_4ca300_256x240', '/$0.png');
	toolAssets.regImg('tool/ui-icons_222222_256x240', '/$0.png');
	toolAssets.regImg('tool/ui-icons_bbbbbb_256x240', '/$0.png');
	toolAssets.regImg('tool/ui-icons_ededed_256x240', '/$0.png');
	toolAssets.regImg('tool/ui-icons_ffcf29_256x240', '/$0.png');
	toolAssets.regImg('tool/ui-icons_ffffff_256x240', '/$0.png');


	toolApp.addPage('tool', '../../www/pages/tool', { assetMap: toolAssets });
...
exports.addGm = function (state, username, password, rights, callback) {
	...
	async.waterfall([
		...
		function (callback) {
			...
			var password = crypto.createHmac('sha1', config.hashkey).update(password).digest('hex');
