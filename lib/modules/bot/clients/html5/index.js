(function (window) {
	...
	mod.createBotPlayer = function (options, cb) {
		mod.pskCreateBotPlayer(psk, options, cb);
	};

	mod.startBotSession = function (actorId, options, cb) {
		mod.pskStartBotSession(psk, actorId, options, cb);
	};
