...
(function (window) {
	...
	mithril.loader.on('shop.display', function () {
		mithril.setupModules(['actor', 'obj', 'shop'], function (error) {
			if (error) {
			...
			var fragment = '';
			var classes = shop.classes = mithril.obj.getClassesByName();
			...
			mithril.shop.getShops(null, function (error, results) {
				if (error) {
