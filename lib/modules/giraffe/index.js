...
exports.postNotifications = function (messages, defaultMessage, options) { //messages = { actorId: 'message', .. }
	...
	resolveActors(state, actorIds, function (error, userMap) {
		...
		exports.send('post', { token: '', secret: '' }, '/Gameplatform/ApplicationNotificationMessageMulti', null, postData, function () {}); //fire and forget
	});
};
