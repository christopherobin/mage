(function () {
	...
	// landing page:
	//   mithril.mui.on('main.ready', function () { syncDone = true; .. onclick: mithril.mui.displayPage('main'); });
	//   download assets
	//   if uptodate:
	//     render "synchronizing"
	//   else if downloadsStart:
	//     render progress bar
	//     on downloadsComplete:
	//       if syncDone:
	//         display play button
	//       else:
	//         render "synchronizing"

	// main: mithril.setup() -> mithril.mui.renderPage('main'); app.init() -> mithril.mui.emit('main.ready');
