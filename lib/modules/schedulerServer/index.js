...
exports.setup = function (state, cb) {
	...
	if (cfg && cfg.debug) {
		...
		prefix = '' + Date.now();
		ttl = 600;
		logger.notice('SchedulerServer: Debug activated. Using prefix ' + prefix + ' and ttl=' + ttl + '.');
	} else {
		// Use no prefix and persist things forever.
		logger.notice('SchedulerServer: Production mode.');
	}
...
/**
 * Returns a list of commands that may be exposed.
 *
 * @return {Array}
 */
