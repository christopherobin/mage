...
var clientEndpoint = cfg.clientBaseUrl || mage.core.msgServer.getClientHost().getClientHostBaseUrl();
...
exports.setJob = function (jobId, schedule, timezone, cb) {
	...
	if (cb.length !== 2 && cb.length !== 3) {
		throw new TypeError('The callback signature must be either (state, cb) or (state, message, cb)');
	}
