...
// Declared up here to make jshint happy about a circular dependency.
var resendQueue;
var onTransportError;
var sendQueue;
var setTimerIfNeeded;
...
resendQueue = function (cmdCtrClient, queue) {
...
onTransportError = function (cmdCtrClient, failedQueue) {
...
sendQueue = function (cmdCtrClient) {
...
setTimerIfNeeded = function (cmdCtrClient, delay) {
	if (cmdCtrClient.timer === null) {
		cmdCtrClient.timer = setTimeout(function () {
			cmdCtrClient.timer = null;
			cmdCtrClient.sendQueue(cmdCtrClient);
		}, delay || 0);
	}
};
