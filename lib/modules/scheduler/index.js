...
var mithril = require('../../mithril'),
	...
	lookupCode = function (appName, taskName) {
		if (typeof appName === "string" || typeof taskName === "string") {
...
exports.register = function (appName, taskName, code) {
	if (typeof appName !== "string" || typeof taskName !== "string" || typeof code !== "function") {
...
exports.parseSchedule = function (schedule) {
	...
	if (schedule instanceof Duration) {
		return new HeartBeat(schedule);
	}

	if ((schedule instanceof Date) || (schedule instanceof HeartBeat) || (schedule instanceof Cron)) {
		return schedule.isInvalid() ? null : schedule;
	}
 ...
 * @param {String} appName
 * @param {String} taskName
 * @param {Object} schedule A Date, Cron, Duration or HeartBeat object.
 * @param {Object} data
 * @api public
 */
