...
exports.applyDiff = function (topic, index, data) {
	// since applyDiff is called by the execution of data-mutation, we don't have to go through
	// operations.exec in this case

	operations.queue.applyDiff(topic, index, data);
};
