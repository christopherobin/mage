...
VaultValue.prototype.touch = function (expirationTimeOnServer) {
	...
	var serverTimeToClientTime = null;
	if (time) {
		serverTimeToClientTime = time.serverTimeToClientTime;
	}

	this.expirationTime = expirationTimeOnServer ? serverTimeToClientTime(expirationTimeOnServer) : undefined;
