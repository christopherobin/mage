...
(function (window) {
	...
	if (mod.rawAdd) {
		mod.add = function (topic, index, data, mediaType, encoding, expirationTime, cb) {
			cb = cb || function () {};
			...
			mod.rawAdd(topic, index, data, mediaType, encoding, expirationTime, cb);
		};
	}


	if (mod.rawSet) {
		mod.set = function (topic, index, data, mediaType, encoding, expirationTime, cb) {
			cb = cb || function () {};
			...
			mod.rawSet(topic, index, data, mediaType, encoding, expirationTime, cb);
		};
	}
