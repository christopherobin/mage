...
var pkg = require('mage-loader.js').getPackage('config-inspector');
...
Color.prototype.brightness = function (ratio) {
	return new Color(this.r * ratio, this.g * ratio, this.b * ratio);
};
