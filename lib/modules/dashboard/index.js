...
exports.createDashboard = function (appName, cb) {
	...
	function addPage(fullPath, options) {
		...
		// TEMPORARY HACK TO PREVENT ASSETS PAGE BEING LOADED
		if (Array.isArray(pageInfo.apps) && pageInfo.apps.indexOf(appName) !== -1 && name !== 'assets') {
			// add the page to the list

			loader.registerComponent(name, fullPath, options);
	...
	loader.registerComponent('home', pathJoin(__dirname, 'dashboard/pages/home'));
