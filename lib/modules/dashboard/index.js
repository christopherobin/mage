...
function createDashboard(appName, cb) {
	...
	loader = app.addIndexPage('loader', './node_modules/mage/lib/modules/dashboard/dashboard/dashboardLoader');
	loader.registerComponent('login', './node_modules/mage/lib/modules/dashboard/dashboard/pages/login', { assetMap: true });
