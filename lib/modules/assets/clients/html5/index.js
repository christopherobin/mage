...
// It is now the assets module.
//  - lib/modules/assets/component.json
//  - lib/modules/assets/client.js

(function (window) {

	var mage = window.mage;

	var mod = mage.registerModule($html5client('module.assets.construct'));
	...
	Asset.prototype.getContents = function (options, cb) {
		if (!mage.io || !mage.io.transports || !mage.io.transports.http) {
	...
	mod.setup = function (cb) {
		...
		var assetMaps = mage.loader.getDownloadedParts('text/assetmap');
