(function () {
	...
	function downloadFile(asset, index, total, callback) {
		mod.emit('beforeDownloadFile', index, total, asset);
		...
		wizAssets.downloadFile(
			...
			function (localUrl) {
				...
				mod.emit('afterDownloadFile', index, total, asset);
	...
	function downloadFiles(list, parallel, callback) {
		...
		(function next() {
			...
			if (asset) {
				...
				downloadFile(asset, index, totalDownloads, function () {
					activeDownloads--;
					remainingDownloads--;
