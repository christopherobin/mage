...
AssetMap.prototype.indexAsset = function (absPath, relPath, stats, cb) {
	...
	calcDigest(absPath, stats, function (error, digest) {
		...
		that.addAsset(absPath, relPath, digest, stats.size);
...
AssetMap.prototype.indexFolder = function (folder, cb) {
	...
	logger.verbose('Indexing folder', folder);
...
AssetMap.prototype.indexPage = function (pageInfo) {
	logger.verbose('Indexing page', pageInfo.name);
...
var builder = {
	build: function (buildTarget, clientConfig, contextName, assetMap, cb) {
