...
AssetMap.prototype.getBaseUrl = function (context, headers) {
	...
	logger.warning('No baseUrl configured for asset context:', context, '(reverting to built-in asset serving)');
...
AssetMap.prototype.saveDigestCache = function (folder, cache, cb) {
	...
	fs.writeFile(digestCachePath, JSON.stringify(cache), cb);
};
