...
exports.getUrl = function (uri, language) {
	...
	var baseUrl = mithril.core.config.get('module.assets.baseUrl.' + uri.context);
	if (baseUrl === null) {
...
exports.setup = function (state, cb) {
	mithril.core.app.builders.add('assets', function (page, language, contextName, key, cb) {
		cb(null, JSON.stringify(exports.getTranslationMap(language)));
	});
