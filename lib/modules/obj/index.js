...
exports.getClassActorProperties = function (state, classId, actorId, options, cb) {
	var config = {
		domain: {
			...
			events: {
				path: 'obj.class.actordata.$type.' + classId + '.$propertyName',
				actorIds: [actorId],
				identifier: 'classId'
			}
		}
...
exports.getObjectProperties = function (state, objectId, options, cb) {
	...
	if (options.syncActorIds) {
		config.domain.events = {
			path: 'obj.object.data.$type.' + objectId + '.$propertyName',
			actorIds: options.syncActorIds,
			identifier: 'objectId'
		};
	}
...
exports.getFullCollectionByType = function (state, type, owner, cb) {
	...
	exports.getCollectionIdByType(state, type, owner, null, function (error, id) {
		...
		exports.getFullCollection(state, id, cb);
	});
};
...
exports.getFullCollection = function (state, collectionId, cb) { //TODO: often used without data, make data optional?
	...
	async.waterfall([
		...
		function (rows, callback) {
			...
			exports.getObjectsProperties(state, objectIds, {}, callback);	// TODO: so if we do not preload any values, what's the point of even having these property maps?
		},
