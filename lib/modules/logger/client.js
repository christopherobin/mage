...
function serializeError(error) {
	// try to use stacktrace.js to get a solid cross-browser compatible stacktrace
	...
	try {
		...
		// we can only ignore this problem at this point, and do a poor-mans job at turning the
		// stack into an array
...
function jsonSerialize(arg) {
	...
	function serialize(obj) {
		...
		if (Element && obj instanceof Element) {
			uniqueSelector = uniqueSelector || require('unique-selector');
