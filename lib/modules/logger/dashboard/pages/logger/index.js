...
var pkg = require('mage-loader.js').getPackage('logger');
...
function makeSocket() {
	...
	var address = mage.getSavvyBaseUrl(protocol) + '/logger';
	...
	websocket.onclose = function () {
		...
		window.setTimeout(makeSocket, 2000);
	};
}
...
pkg.once('show', function (pageElm) {
	buildPage(pageElm);
