...
exports.getEvents = function (state, type, dates, participants, dataFilter, cb) { //TODO: test this function
		...
		[
			function (callback) {
				...
				if (filterCount > 0) {
					...
					for (var i = 0; i < filterCount; i++) {
						...
						params.push(filter.property, mage.core.PropertyMap.serialize(filter.value));
			...
			function (eventData, callback) {
				...
				for (i = 0; i < len; i++) {
					var evt = eventData[i];
					evt.actors = [];
					evt.data = new mage.core.PropertyMap();
