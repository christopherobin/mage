...
exports.close = function (cb) {
	...
	var timer = setTimeout(function () {
		...
		logger.warning('Closing HTTP server timed out after', CLOSE_TIMEOUT / 1000, 'seconds.');

		// allow Node to gracefully exit, even if the server hasn't closed yet
	...
	server.close(function () {
		logger.verbose('HTTP server closed');
