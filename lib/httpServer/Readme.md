...
You can listen to it from the httpServer `httpServer.on('io.error.network', doSomething);`.
The suggestion here is to retry (`httpServer.resend();`) on a network error and to reload the app after n retries.
