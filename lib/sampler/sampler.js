 ...
 */
function persistToTopic(deliveredSamples) {
	var topic = mage.core.config.get(['sampler', 'persist', deliveredSamples.name]);
...
exports.setup = function (cb) {
	...
	intervalNames.forEach(function (name) {
		...
		if (mage.core.config.get(['sampler', 'persist', name])) {
			panopticon.on('delivery', persistToTopic);
		}
