...
WorkerManager.prototype.killWorker = function (worker, graceful, cb) {
	...
	var shutdownGracePeriod = graceful ? mage.core.config.server.shutdownGracePeriod : 2;
...
processManager.passDependencies = function (mageInstance, mageLogger) {
	mage = mageInstance;
	logger = mageLogger;
...
processManager.setup = function () {
	mage.core.config.setTopLevelDefault('server', {
		cluster: 0,
	...
	var numberOfWorkers = mage.core.config.server.cluster;
