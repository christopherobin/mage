	...
	function buildScripts(builder, isTarget, buildTarget, callback) {
		...
		builder.buildScripts(function (error, script) {
			...
			builder.buildAliases(function (error, aliases) {
				...
				// Fix sourceURLs, since component-builder is doing it old-style. Once this is fixed
				// in component-builder, we can remove this line of code.

				script = script.replace(/\/\/@ sourceURL=/gm, '//# sourceURL=');
