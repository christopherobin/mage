...
WebApp.prototype.setIndexPage = function (path, options) {
	...
	this.addBuildTarget(new BuildTarget(this, 'dir', path, context, routes, options, true));
};
...
WebApp.prototype.addPage = function (name, path, options) {
	...
	var page = new BuildTarget(this, 'web', name, context, routes, options, true);
...
WebApp.prototype.setManifest = function (manifest) {
	...
	var buildTarget = new BuildTarget(this, 'web', name, context, routes, options, true);
