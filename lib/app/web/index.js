...
WebApp.prototype.getIndexPageVariants = function (pageName) {
	...
	return this.clientConfigs.map(function (clientConfig) {
		...
		if (!response && that.delivery.serverCache) {
...
WebApp.prototype.makeBuilds = function (cb) {
	// TODO: should this check be turned into mage.isDevelopmentMode() so we can do away
	//       with serverCache configuration altogether?
