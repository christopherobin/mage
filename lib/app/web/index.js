...
function WebApp(name, options) {
	...
	this._commandCenter = new mage.core.cmd.CommandCenter(this);
...
WebApp.prototype.getName = function () {
	return this.name;
};


WebApp.prototype.getAccess = function () {
	return this.access;
};


WebApp.prototype.getCommandCenter = function () {
	return this._commandCenter;
};
