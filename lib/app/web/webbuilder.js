...
function buildComponentPage(buildTarget, clientConfig, key, cb) {
	...
	// The day we do full, 100% real component builds, we should ideally drop the "html" context
	// build (would remove all directory scanning, and thus improve build-performance)
