...
function buildComponent(buildTarget, clientConfig, key, cb) {
	if (!clientConfig) {
...
exports.build = function (buildTarget, clientConfig, contextName, key, cb) {
	...
	if (contextName === 'magepage') {
		...
		return buildMagePage(buildTarget, clientConfig, context, cb);
	}

	if (contextName === 'component') {
		return buildComponent(buildTarget, clientConfig, key, cb);
	}
