...
contexts.add('html', 'text/html; ' + UTF8, '\n').addFileExtensions(['html', 'htm']);
contexts.add('css',  'text/css; ' + UTF8, '\n').addFileExtensions(['css']);
contexts.add('js',   'text/javascript; ' + UTF8, '\n').addFileExtensions(['js']);
contexts.add('xml',  'application/xml; ' + UTF8, '\n').addFileExtensions(['xml']);

contexts.add('magepage',  'text/magepage; ' + UTF8, '\n');
contexts.add('manifest',  'text/cache-manifest; ' + UTF8, '\n');
contexts.add('component', 'text/component; ' + UTF8, '\n');
