...
var timeoutMsec = mage.core.config.get(['server', 'killProcess', 'timeoutMsec']);
...
function sendSignal(pid, signal, cb) {
...
function start(app, cb) {
	...
	sendSignal(null, null, function (exitCode) {
...
function stop(app, cb) {
	...
	sendSignal(app.pid, CMD_QUIT, function (exitCode) {
...
function reload(app, cb) {
	...
	sendSignal(app.pid, CMD_RELOAD, cb);
}
