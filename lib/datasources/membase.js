...
MembaseStore.prototype.incr = MembaseStore.prototype.increment = function (key, size, cb) {
	var client = this.connect();
	var state = this.state;
...
MembaseStore.prototype.decr = MembaseStore.prototype.decrement = function (key, size, cb) {
	var client = this.connect();
	var state = this.state;
