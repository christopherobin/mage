...
MySqlDatabase.prototype._connect = function (config, cb) {
	...
	client.connect(function (error) {
		if (error) {
			logger.error('Failed to connect to MySQL server at', client.host + ':' + client.port);
			return cb(error);
		}

		logger.verbose('Connected to MySQL server at', client.host + ':' + client.port);
...
MySqlDatabase.prototype.getOne = function (sql, params, required, errorCode, cb) {
	...
	this.source(true, function (error, db) {
		...
		query(db, sql, p, function (error, results) {
