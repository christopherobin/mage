...
function DataSources(state) {
	...
	var data = mithril.core.config.get('data');
...
exports.close = function (cb) {
	...
	mithril.core.logger.mithril_debug('Closing all datasources...');
	...
	if (closeAllTimeout) {
		setTimeout(function () {
			mithril.core.logger.alert('Failed to gracefully close all datasources (some are still open), timing out.');
			closeAll();
		}, closeAllTimeout);
	}
};
