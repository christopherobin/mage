...
var MySqlDatabase = require('./mysql').MySqlDatabase;
var MembaseStore = require('./membase').MembaseStore;
...
function DataSources(state) {
	...
	var data = mage.core.config.data;
...
exports.close = function (cb) {
	...
	mage.core.logger.verbose('Closing all datasources...');
