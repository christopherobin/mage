...
function Mage() {
	...
	this.msgServer = new MsgServer(this.appName, this.clientHostBaseUrl, {
		withCredentials: this.config.cors && this.config.cors.credentials ? true : false,
		cmdMode: 'blocking'  // modes: "free", "blocking" (default)
	});

	// for backwards compatibility (DEPRECATED):
	this.io = this.msgServer;
...
Mage.prototype.getSavvyBaseUrl = function (protocol) {
	...
	if (!baseUrl) {
		...
		baseUrl = this.savvyBaseUrl = window.location.protocol + '//' + window.location.host + '/savvy';
