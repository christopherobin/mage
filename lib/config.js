...
// Rename setModuleDefaults to setTopLevelDefault
 ...
 * hit at any point, alt is returned instead.
 *
...
config.get = function (modPath, alt) {
	var path = (Array.isArray(modPath) ? modPath.slice() : modPath.split('.')).reverse();
	var conf = config;
