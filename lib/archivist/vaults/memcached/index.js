...
exports.defaultValueHandlers = {
	...
	deserialize: function (data, value) {
		// let mediaType and encoding be detected by the VaultValue

		value.initWithData(null, data, 'live');
	},
	key: function (value) {
...
Archive.prototype.create = function (api, value, cb) {
	this.vault.set(api.key(value), api.serialize(value), value.expirationTime, cb);
};
...
Archive.prototype.touch = function (api, value, cb) {
	this.vault.touch(api.key(value), value.expirationTime, cb);
};
