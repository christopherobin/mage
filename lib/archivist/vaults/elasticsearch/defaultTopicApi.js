...
exports.serialize = function (value) {
	...
	if (Buffer.isBuffer(data)) {
		throw new TypeError('Elasticsearch does not support direct storage of buffers, see documentation for more details.');
	}
	return data;
};
...
/**
 * The shard function is null by default as Elasticsearch uses the object key for sharding, you can override that here.
 *
 * @params {VaultValue} value The value to shard
 * @returns {null|string} A string used for sharding
 */
