...
FileVault.prototype.addMeta = function (filenameWithoutExt, meta, cb) {
	...
	createKeyFolders(filenameWithoutExt, filePath, function (error) {
		...
		writeWithOptions(filePath, { flags: 'wx' }, JSON.stringify(meta, null, '\t'), function (error) {
			if (error) {
				that.logger.alert('Failed to add meta data to:', filePath, error);
			}
...
FileVault.prototype.setMeta = function (filenameWithoutExt, meta, cb) {
	...
	createKeyFolders(filenameWithoutExt, filePath, function (error) {
		...
		writeWithOptions(filePath, { flags: 'w' }, JSON.stringify(meta, null, '\t'), function (error) {
			if (error) {
				that.logger.alert('Failed to set meta data to:', filePath, error);
			}
