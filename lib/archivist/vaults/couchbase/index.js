...
/**
 * Couchbase migrations are mainly used for views, while we can't know for sure
 * which views have been created we can nuke the migration key and force migrations
 * to run again
 *
 * @param {Function} cb  Called upon completion.
 */
CouchbaseVault.prototype.dropDatabase = function (cb) {
	this.remove('schema_migrations', {}, function (error) {
