...
/**
 * registerTopicConfig receives a map for a topic that may contain:
 * - "vaults": { vaultName: { an API per supported vault name (true for default behavior) } }
 * - "readOptions" object, containing optionally "mediaTypes", "encodings", "optional"
 * - an afterLoad function
 * - a beforeDistribute function
 * - an index array that lists the names of all fields in the index, defaults to []
 *
 * @param {string}          topic            The name of the topic.
 * @param {Object}          cfg              The user defined configuration of the topic.
 * @param {Object.Array}    index            The names of the index properties. Defaults to [].
 * @param {Object.Object}   readOptions      Read options for this topic, applied after each "get".
 * @param {Object.Function} afterLoad        Gets called immediately after each successful "get".
 * @param {Object.Function} beforeDistribute Gets called immediately before distribution of changes.
 */
