...
require('./vaultValue').setLogger(logger);
...
function attemptListIndexesFromVault(state, vault, topic, partialIndex, options, cb) {
	...
	vault.archive.listIndexes(valueHandler, topic, partialIndex, options, function (error, indexes) {
		if (error) {
...
Archivist.prototype.listIndexes = function (topic, partialIndex, options, cb) {
