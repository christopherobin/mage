...
/**
 * registerTopics receives a map that per topic may contain:
 * - a value handler API per supported vault name (true for default behavior)
 * - a readOptions object, containing optionally "mediaTypes", "encodings", "optional"
 * - an afterLoad method
 * - a beforeDistribute method
 * - an index array that lists the names of all fields in the index
 *
 * @param {Object} topics
 */
