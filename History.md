...
// pattern 3: everybody may read this, but changes won't be broadcast to every player in the game
...
```js
// pattern 4: everybody may read this, changes will be sent to playerId
